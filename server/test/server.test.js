...
describe('DELETE /todos/:id', () => {
  ...
  it('should return a 404 if NO todo', (done) => {
    request(app)
...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completedAt when completed is changed to false', (done) => {
    const hexId = todos[1]._id.toHexString();
    const text = 'This is the second new text';
...
describe('POST /users', () => {
  it('should create a user', (done) => {
    const email = 'testSample@testSample.com';
    const password = '007Bond';
  ...
  it('should return validation errors if request is missing data', (done) => {
    request(app)
      .post('/users')
      .send({
        email: 'and',
